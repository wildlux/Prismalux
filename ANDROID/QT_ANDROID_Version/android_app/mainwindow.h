...
private:
    ...
    PipelinePage*        m_pipelinePage        = nullptr;
    SfidaPage*           m_sfidaPage           = nullptr;
    CronPage*            m_cronPage            = nullptr;
    EditorPage*          m_editorPage          = nullptr;
    RicercaMobPage*      m_ricercaMobPage      = nullptr;
    CollabPage*          m_collabPage          = nullptr;
    AppControllerPage*   m_appControllerPage   = nullptr;
    ...
    int m_idxPipeline        = 26;
    int m_idxSfida           = 27;
    int m_idxCron            = 28;
    int m_idxEditor          = 29;
    int m_idxRicercaMob      = 30;
    int m_idxCollab          = 31;
    int m_idxAppController   = 32;
