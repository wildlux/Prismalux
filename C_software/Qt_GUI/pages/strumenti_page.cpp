...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
static const char* kSysPrompts[10][8] = {
    /* 0 — Studio */
    {
...
static const char* kSubActions[10][8] = {
    ...
    : QWidget(parent), m_ai(ai)
{
    ...
    m_ragRow->setStyleSheet(
        "QWidget{background:#111827;border:1px solid #1e3a5f;"
    ...
    ccBanner->setStyleSheet(
        "background:#1a2032;border:1px solid #334155;"
