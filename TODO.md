...
- **CLAUDE.md** è in ritardo: 8 suite registrate non documentate (`AiClient`, `AiMemory`, `DepCheckPanel`, `Distillazione`, `GraphMemoryConcurrent`, `LanWanCore`, `McpIntegration`, `PerceptorScripts`). Aggiornare dopo i test.
