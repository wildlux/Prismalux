...
|---|---|---|---|
| T-D9 | Freeze "Non risponde" all'avvio (colonna che si comprime) | Doppio click sull'icona un paio di volte di fila, con schermata se possibile — ultimo fix (timer pre-build protetti) non ancora confermato dall'utente dopo il primo tentativo fallito (ipotesi Analisi 1/2 insufficiente) | D-9 |
