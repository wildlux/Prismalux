    ...
    : QWidget(parent)
{
    ...
    auto* hdr = new QLabel(
        ...
        "Fotovoltaico \xc2\xb7 Idroponica \xc2\xb7 Lavoro \xc2\xb7 Finanza \xc2\xb7 Bici \xc2\xb7 Mod Giochi \xc2\xb7 LAN & WAN"
        "</span>", this);
    ...
    m_tabs->addTab(new ModGiochiWidget(ai, m_tabs),
                   "\xf0\x9f\x8e\xae  Mod Giochi");
}
