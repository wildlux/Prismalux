...
QWidget* RicercaPage::buildRagTesterTab()
{
    ...
    /* ── Slot: Genera domande ── */
    connect(m_ragTesterGenBtn, &QPushButton::clicked, this, [this]() {
        ...
        /* Lambda richiamata con il testo estratto: avvia la generazione AI */
    ...
    connect(m_ragTesterRunBtn, &QPushButton::clicked, this, [this]() {
    ...
    connect(m_ragTesterEvalBtn, &QPushButton::clicked, this, [this]() {
        const QString questions = m_ragTesterQuestions
                                  ? m_ragTesterQuestions->toPlainText().trimmed() : "";
