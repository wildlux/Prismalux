...
| `AiClient` | `test_ai_client` | 48 PASS — CAT-A classifyQuery, CAT-B detectQueryDomain, CAT-B2 `detectQueryIsEnglish` (D-28), CAT-C SmartRouter API, CAT-D abort()/aborted(), CAT-E mock HTTP 4xx/5xx |
