...
| `AiClient` | `test_ai_client` | 75 PASS — CAT-A classifyQuery, CAT-B detectQueryDomain (+ B-9…B-15 regressioni D-68 da dati reali: parole comuni IT non scattano domini scientifici, match \b-delimitato), CAT-B2 `detectQueryIsEnglish` (D-28), CAT-B3 `dateTimeDirective` (D-31), CAT-B4 `scrubPii` (D-32), CAT-C SmartRouter API, CAT-D abort()/aborted(), CAT-E mock HTTP 4xx/5xx |
