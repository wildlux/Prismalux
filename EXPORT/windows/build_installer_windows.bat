...
set BUILD_DIR=%SCRIPT_DIR%..\..\build_installer
set DEPLOY_DIR=%SCRIPT_DIR%..\..\Prismalux_Deploy
set ZIP_NAME=%SCRIPT_DIR%Prismalux_Windows_Installer.zip

echo [1/4] Configuring CMake...
cmake -B "%BUILD_DIR%" -S "%GUI_DIR%" -G "MinGW Makefiles" ^
